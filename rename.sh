...
echo "Renaming all 'PostgresTraining' -> '$PASCAL'"
echo "Renaming all 'PostgresTraining' -> '$CAMEL'"
...
find . -type d -not -path '*/\.git/*' | sed -e "p;s/PostgresTraining/$PASCAL/" | xargs -n2 mv
find . -type d -not -path '*/\.git/*' | sed -e "p;s/PostgresTraining/$CAMEL/" | xargs -n2 mv
# file names
...
find . -type f -not -path '*/\.git/*' | sed -e "p;s/PostgresTraining/$PASCAL/" | xargs -n2 mv
find . -type f -not -path '*/\.git/*' | sed -e "p;s/PostgresTraining/$CAMEL/" | xargs -n2 mv
# strings
find . -type f -not -path '*/\.git/*' -exec sed -i "s/base_api/$SNAKE/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/base-api/$KEBAB/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/PostgresTraining/$PASCAL/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/PostgresTraining/$CAMEL/g" {} \;
